package com.example.adaminfiesto.droppit.Geo;
...
public class GeofenceBroadcastReceiver extends BroadcastReceiver
{
    ...
    private void sendNotification(Context context, int transitionType)
    {
        ...
        Intent notificationIntent = new Intent(context, GoogleActivity.class);
        ...
        else if (transitionType == Geofence.GEOFENCE_TRANSITION_EXIT)
        {
            builder.setSmallIcon(R.drawable.ic_account_circle_black_24dp)
                    .setLargeIcon(BitmapFactory.decodeResource(context.getResources(),
                            R.drawable.ic_location_city_black_24dp))
                    .setContentTitle("normal else if test");
        }

        // Continue building the notification
        builder.setContentText("relaunch");
